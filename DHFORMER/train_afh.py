...
from models.ahf_stgcn import AHF_STGCN as Network
from trainer.BasicTrainer import Trainer
...
#data
args.add_argument('--config', default=config_file, type=str, help='configuration file path')
args.add_argument('--train_ratio', default=float(config['data'].get('train_ratio', 0.7)), type=float)
args.add_argument('--val_ratio', default=config['data']['val_ratio'], type=float)
args.add_argument('--test_ratio', default=config['data']['test_ratio'], type=float)
args.add_argument('--dataset_path', default=config['data'].get('dataset_path', ''), type=str)
